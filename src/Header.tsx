import { Link, NavLink, useSearchParams, useNavigate, Form } from 'react-router-dom'; //client side navigation.
...
export function Header() {
  ...
  //   const formControlData = formData.get('tf1') as string;
  ...
  return (
    <header className="text-center text-slate-50 bg-slate-900">
      ...
      <nav>
        ...
        <Link
          to="admin"
          className="text-white no-underline p-1 pb-0.5 border-solid border-b-2 border-transparent"
        >
          Admin
        </Link>
      </nav>
